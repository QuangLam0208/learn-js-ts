...
const addNewRowWithJS = (post: IPost) => {
    ...
    const btnDeleteElement = document.querySelector(`[data-delete-id="${post.id}"]`)! as HTMLButtonElement;
    actionClickDelete(btnDeleteElement);

    const btnUpdateElement = document.querySelector(`[data-update-id="${post.id}"]`)! as HTMLButtonElement;
